...
1. Trigger, Over Mountain with Aluminum Frame: $4,970

2. Slice, Triathalon with Aluminum Frame: $2,468

_Next Steps_: Integrate the model into a proof-of-concept web application that can be deployed
...
1. New _Aluminum_ line of bikes in the _Over Mountain Category_

2. New _Aluminum_ line of bikes in the _Triathalon_
